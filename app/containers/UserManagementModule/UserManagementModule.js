...
import { createNewRole, createUserAndConnection, createUserConnection, updateUserConnection, registerNewOrgUser,
  findEntityBy, } from 'containers/AppData/actions';
...
const key = "userManagementModule";
...
const mapStateToProps = createStructuredSelector({
  ...
  selectedUsers: selectors.makeSelectSelectedUsers()
...
const mapDispatchToProps = (dispatch) => {
  return {
    ...
    setSelectedUsers: (users) => dispatch(actions.setSelectedUsers(users))
  };
}
